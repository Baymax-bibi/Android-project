...
namespace ExitGames
{
	namespace Common
	{
		...
		/** @fn CustomTypeFactory::sizeOf()
		    @returns the size of a single �nstance as determined by calling the sizeof()-operator, for the class, which is fabricated by this specialization of the factory  */
