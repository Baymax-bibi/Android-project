	...
	namespace Photon
	{
		...
		namespace Punchthrough
		{
			...
			private:
				...
				void handlerPong(int idIncoming);
				...
				Common::JVector<nByte> buildStunImplementation(nByte id, Internal::Punchthrough::Forwards::StunMsgType stunMsgType, const nByte* pMsgID);
