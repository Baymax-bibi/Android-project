...
public class MainActivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        ((Button)findViewById(R.id.buttonLeave)).setOnClickListener(new View.OnClickListener()
        {
        ...
        ((Button)findViewById(R.id.buttonJoin)).setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View v)
            {
        ...
        ((Button)findViewById(R.id.buttonCreateDirectAllToAll)).setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View v)
            {
                mViewMasterServer.setVisibility(View.INVISIBLE);
                createGameDirectAllToAll();
            }
        });

        ((Button)findViewById(R.id.buttonCreateDirectMasterToAll)).setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View v)
            {
                mViewMasterServer.setVisibility(View.INVISIBLE);
                createGameDirectMasterToAll();
            }
        });
