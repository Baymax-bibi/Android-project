...
class RankingListAdapter (private val context: Activity, private val title: Array<String>, private val description: Array<String>, private val imgid: Array<String>)
    : ArrayAdapter<String>(context, R.layout.item_ranking, title) {

    override fun getView(position: Int, view: View?, parent: ViewGroup): View {
        val inflater = context.layoutInflater
        val rowView = inflater.inflate(R.layout.item_ranking, null, true)
