...
public class fragment_shifter extends Fragment implements View.OnClickListener{
    GridView gridview;
    ArrayList<character_model> arrayOfCharacters;
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_catalogue_shifter, container, false);
