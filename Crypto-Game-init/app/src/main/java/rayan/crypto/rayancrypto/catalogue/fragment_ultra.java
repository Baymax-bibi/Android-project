...
public class fragment_ultra extends Fragment implements View.OnClickListener{
    GridView gridview;
    ArrayList<character_model> arrayOfCharacters;
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_catalogue_ultra, container, false);
